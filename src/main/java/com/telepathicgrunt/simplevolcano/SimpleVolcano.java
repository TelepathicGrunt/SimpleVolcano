package com.telepathicgrunt.simplevolcano;

import org.apache.logging.log4j.Level;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;

import com.telepathicgrunt.simplevolcano.world.features.FeatureInit;
...
@Mod(SimpleVolcano.MODID)
public class SimpleVolcano
{
	// Directly reference a log4j logger.
	public static final Logger LOGGER = LogManager.getLogger();
	//mod ID to reference to from anywhere in mod
	public static final String MODID = "simplevolcano";


	public SimpleVolcano()
	{
	...
	{
		entry.setRegistryName(new ResourceLocation(SimpleVolcano.MODID, registryKey));
